...
namespace PlayTennis.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // L'azione Authorize è l'endpoint che viene chiamato quando si accede a
        // una Web API protetta. Se l'utente non è connesso, verrà reindirizzato alla 
        // pagina Login. Dopo l'esecuzione dell'accesso è possibile chiamare una Web API.
        [HttpGet]
